...
namespace Yatt.Api.Migrations
{
    ...
    [Migration("20220828171244_AddWebUrlToCompany")]
    partial class AddWebUrlToCompany
    {
            ...
            modelBuilder.Entity("Yatt.Models.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = "melaku1234",
                            CreatedDate = new DateTime(2022, 8, 28, 17, 12, 43, 538, DateTimeKind.Utc).AddTicks(8542),
                            Email = "melakumen@gmail.com",
                            EmailConfirmed = true,
                            LockCount = 0,
                            ModifyDate = new DateTime(2022, 8, 28, 17, 12, 43, 538, DateTimeKind.Utc).AddTicks(8542),
                            PasswordHash = new byte[] { 119, 151, 95, 15, 172, 241, 226, 106, 78, 105, 178, 71, 148, 112, 247, 240, 21, 100, 139, 179, 0, 5, 31, 33 },
                            PasswordSalt = new byte[] { 155, 57, 194, 95, 202, 149, 44, 25, 244, 17, 254, 44, 237, 179, 19, 22, 7, 228, 13, 249, 101, 79, 170, 68 },
            ...
            modelBuilder.Entity("Yatt.Models.Entities.UserRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            UserId = "melaku1234",
                            CreatedDate = new DateTime(2022, 8, 28, 17, 12, 43, 553, DateTimeKind.Utc).AddTicks(3901),
                            ModifyDate = new DateTime(2022, 8, 28, 17, 12, 43, 553, DateTimeKind.Utc).AddTicks(3901),
                            Role = 102
                        });
                });
