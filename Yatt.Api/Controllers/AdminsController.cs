...
namespace Yatt.Api.Controllers
{
    ...
    {
        public IAdminRepository _repository { get; }
        ...
        [HttpPost]
        public async Task<IActionResult> Create([FromBody] AdminDto model)
        {
            try
            {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Update(string id, [FromBody] AdminDto model)
        {
            if (id != model.Id)
